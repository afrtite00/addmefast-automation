...
browser = webdriver.Chrome(executable_path =r"C:\Users\xeno\Desktop\New folder\chromedriver.exe")
...
def twitter():
	...
	user.send_keys('usrname dyal twitter')
	sleep(2)
	passw = browser.find_element_by_css_selector('.js-password-field')
	passw.send_keys('password dyal twitter')
...
def addme_login():
	...
	email = 'email dyal addmefast'
	user.send_keys(email)
	passw = browser.find_element_by_css_selector('.password')
	passw.send_keys('password addmefast')
